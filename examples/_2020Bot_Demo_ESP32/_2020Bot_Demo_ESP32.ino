...
void handleRoot() {
  ...
  String root = ""
    ...
    "</head>"
    "<body>"
    "<input type=\"button\" onclick=\"remote();\" value=\"Remote\" />"    
    "<input type=\"button\" onclick=\"auto();\" value=\"Autonomous\" />"    
    "<br />"
    "<input type=\"button\" onclick=\"forward();\" value=\"FWD\" /><br />"    
    "<input type=\"button\" onclick=\"left();\" value=\"L\" />"    
    "<input type=\"button\" onclick=\"stop();\" value=\"STOP\" />"    
    "<input type=\"button\" onclick=\"right();\" value=\"R\" /><br />"    
    "<input type=\"button\" onclick=\"reverse();\" value=\"REV\" /><br />"
    "</body>"
    "</html>";
